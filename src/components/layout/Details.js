...
const Details = ({ title, place, placeLink, time, location, description }) => {
  ...
  return (
    <li ref={ref} key={ref} className="my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col">
      ...
      <div>
        ...
        <p className="font-medium w-full text-sm md:text-xl dark:text-light">{description}</p>
      </div>
    </li>
  )
}
